...
- [28. A Comprehensive Guide to Databases: Concepts, Types, and SQL](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#a-comprehensive-guide-to-databases-concepts-types-and-sql)

  - [What is Database?](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#what-is-database)
    - [Why We Need Databases](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#why-we-need-databases)
    - [Types of Databases:](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#types-of-databases)
  - [Types of Databases (`SQL` VS `NoSQL`)](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#types-of-databases-sql-vs-nosql)
    - [1. Data Model](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#1-data-model)
      - [Relational Databases (SQL)](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#relational-databases-sql)
      - [Non-Relational Databases (NoSQL)](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#non-relational-databases-nosql)
    - [2. Query Language](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#2-query-language)
      - [Relational Databases (`SQL`)](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#relational-databases-sql-1)
      - [Non-Relational Databases (`NoSQL`)](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#non-relational-databases-nosql-1)
    - [3. Scalability](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#3-scalability)
      - [Relational Databases (SQL)](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#relational-databases-sql-2)
      - [Non-Relational Databases (NoSQL)](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#non-relational-databases-nosql-2)
    - [4. Transactions](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#4-transactions)
      - [Relational Databases (SQL)](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#relational-databases-sql-3)
      - [Non-Relational Databases (NoSQL)](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#non-relational-databases-nosql-3)
    - [Summary](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#summary)
  - [Understanding Relational Database Concepts (SQL)](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#understanding-relational-database-concepts-sql)
    - [1. Tables](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#1-tables)
    - [2. Rows and Columns](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#2-rows-and-columns)
    - [3. Primary Key](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#3-primary-key)
    - [4. Foreign Key](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#4-foreign-key)
    - [5. Relationships](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#5-relationships)
    - [7. Normalization](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#7-normalization)
    - [8. Transactions](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#8-transactions)
    - [9. Entity-Relationship Diagram (ERD)](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#9-entity-relationship-diagram-erd)
  - [What is SQL?](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#what-is-sql)
  - [SQL command classification / SQL language classification](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#sql-command-classification--sql-language-classification)
    - [1. Data Definition Language (DDL)](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#1-data-definition-language-ddl)
    - [2. Data Manipulation Language (DML)](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#2-data-manipulation-language-dml)
    - [3. Data Retrieval/Query Language (DRL/DQL)](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#3-data-retrievalquery-language-drldql)
    - [4. Data Control Language (DCL)](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#4-data-control-language-dcl)
    - [5. Transaction Control Language (TCL)](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#5-transaction-control-language-tcl)
    - [Summary](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#summary-1)
  - [Basics of SQL Language](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#basics-of-sql-language)
    - [2. SQL Data Types](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#2-sql-data-types)
    - [3. SQL BASIC COMMANDS](https://github.com/sameerkatija/sc-advance-web-class/tree/day-31?tab=readme-ov-file#3-sql-basic-commands)
...
- [29. Introduction to MongoDB and Mongoose: Basics, Setup, and Advanced Concepts](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#introduction-to-mongodb-and-mongoose-basics-setup-and-advanced-concepts)
  ...
  - [Getting Started with MongoDB](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#getting-started-with-mongodb)
    - [1. Start MongoDB](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#1-start-mongodb)
    - [2. Connect to MongoDB](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#2-connect-to-mongodb)
  - [Basic MongoDB Commands](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#basic-mongodb-commands)
    - [Show Databases](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#show-databases)
    - [Create or Switch to a Database](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#create-or-switch-to-a-database)
    - [Show Collections (Tables in relational terms)](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#show-collections-tables-in-relational-terms)
    - [Create or Insert a Document](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#create-or-insert-a-document)
    - [Find Documents](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#find-documents)
    - [Update Documents](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#update-documents)
    - [Delete Documents](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#delete-documents)
    - [Drop a Collection](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#drop-a-collection)
    - [Drop a Database](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#drop-a-database)
  - [Connecting MongoDb with Express](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#connecting-mongodb-with-express)
  - [Object Data Modeling (ODM)](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#object-data-modeling-odm)
  - [What is mongoose?](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#what-is-mongoose)
    - [Key Features of Mongoose](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#key-features-of-mongoose)
      - [1. Schema Definition](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#1-schema-definition)
      - [2. Models](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#2-models)
      - [3. Validation](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#3-validation)
      - [4. Middleware (Hooks)](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#4-middleware-hooks)
      - [5. Query Building](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#5-query-building)
      - [6. Population (Joins)](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#6-population-joins)
      - [7. Async/Await Support](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#7-asyncawait-support)
  - [connect MongoDB with `mongoose`](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#connect-mongodb-with-mongoose)
  - [Defining a Mongoose Model](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#defining-a-mongoose-model)
  - [Implement CRUD Operations](https://github.com/sameerkatija/sc-advance-web-class/tree/day-32?tab=readme-ov-file#implement-crud-operations)
